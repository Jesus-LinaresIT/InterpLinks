...
Revision ID: 147d0e053e14
Revises: dd7c7859d260
Create Date: 2020-08-04 10:56:59.875023
...
revision = '147d0e053e14'
down_revision = 'dd7c7859d260'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('type_appointment', sa.String(length=20), nullable=True),
